...
const translations = {
  ko: {
    ...
    about_body:
      "임상시험 전 주기에 걸쳐 유연하고 스폰서 중심의 임상 서비스를 제공하는 " +
    ...
    skills_eyebrow: "핵심 역량",
    skills_title: "기술은 결정을 돕고, 경험은 방향을 이끕니다.",
    skills_card1_title: "임상 리더십",
    skills_card1_text: "시니어 임상 리더가 전략과 실행을 직접 주도합니다.",
    skills_card2_title: "데이터 기반 운영",
    skills_card2_text: "데이터 기반 인사이트로 운영 의사결정을 지원합니다.",
    skills_card3_title: "AI 기반 실행",
    skills_card3_text: "AI 기반 도구로 효율성과 리스크 관리를 강화합니다.",
    work_eyebrow: "일하는 방식",
    ...
    footer_modal_privacy_body_line1:
  ...
  en: {
    ...
    panel_title: "Synthesis of Leadership & Tech",
    panel_text:
    ...
    skills_eyebrow: "Key Skills",
    skills_title: "Technology strengthens decisions,\nexperience sets direction",
    skills_card1_title: "Clinical Leadership",
    skills_card1_text: "Senior leaders drive strategy and execution directly.",
    skills_card2_title: "Data-driven Operations",
    skills_card2_text: "Operational insights delivered quickly and clearly.",
    skills_card3_title: "AI-enabled Execution",
    skills_card3_text: "AI tools enhance efficiency and risk control.",
    ...
    cta_body: "Let’s discuss the right skills for your clinical trial.",
    ...
    footer_modal_email_body:
      ...
      "this website by automated tools or other technical means. " +
      "Violations may be subject to penalties under applicable laws.",
